...
enum ProfileEditLocalization {
    ...
    static let displayName: String = NSLocalizedString(
    ...
    static let aboutMe: String = NSLocalizedString(
    ...
    static let pronunciation: String = NSLocalizedString(
    ...
    static let pronouns: String = NSLocalizedString(
    ...
    static let location: String = NSLocalizedString(
    ...
    static let jobTitle: String = NSLocalizedString(
    ...
    static let company: String = NSLocalizedString(
    ...
    static let firstName: String = NSLocalizedString(
    ...
    static let lastName: String = NSLocalizedString(
    ...
    static let contactEmail: String = NSLocalizedString(
    ...
    /// User's phone number.
    static let phone: String = NSLocalizedString(
    ...
    static let pronunciationFooterText = NSLocalizedString(
    ...
    static let profileSavedErrorMessage: String = NSLocalizedString(
        ...
        value: "An unknown error occurred while saving your profile",
